 ...
 */
data class WorkerWebSocketTransportConfig(
    ...
    companion object {
        /**
         * Builds a [WorkerWebSocketTransportConfig] from worker runtime settings.
         *
        ...
        ): WorkerWebSocketTransportConfig {
            return WorkerWebSocketTransportConfig(
                workerUid = workerUid,
