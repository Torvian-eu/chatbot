...
import eu.torvian.chatbot.worker.protocol.interaction.AbstractChannelBackedWorkerInteraction
 ...
 */
class WorkerSessionHelloInteraction(
    ...
    private fun handleWelcomeMessage(message: WorkerProtocolMessage) {
        ...
        handshakeStateStore.markSucceeded(
            interactionId = interactionId,
            welcome = WorkerSessionWelcomeState(
