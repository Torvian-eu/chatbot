 ...
 */
interface WorkerLocalMcpProcessManager {
    /**
     ...
     */
    suspend fun startServer(config: LocalMCPServerDto): Either<WorkerLocalMcpStartProcessError, WorkerLocalMcpProcessStatus>
     ...
     */
    suspend fun getServerStatus(serverId: Long): WorkerLocalMcpProcessStatus
