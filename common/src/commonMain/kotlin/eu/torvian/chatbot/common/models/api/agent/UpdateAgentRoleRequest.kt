 ...
 *            a project moves the role there, setting `null` unassociates it. The id (when non-null)
 *            must reference a project owned by the requesting user; a missing or foreign id is
 *            rejected as not-found by the server. The default keeps payloads produced before this
 *            property existed decoding as unassociated.
 */
@Serializable
