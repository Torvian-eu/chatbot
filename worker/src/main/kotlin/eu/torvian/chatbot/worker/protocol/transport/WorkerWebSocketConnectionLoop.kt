 ...
 */
class WorkerWebSocketConnectionLoop(
    private val authManager: WorkerAuthManager,
    private val sessionRunner: WorkerWebSocketSessionRunner,
    ...
    companion object {
         ...
         */
        private val logger: Logger = LogManager.getLogger(WorkerWebSocketConnectionLoop::class.java)
    }
}
