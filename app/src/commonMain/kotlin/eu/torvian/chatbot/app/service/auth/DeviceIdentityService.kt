 ...
 *
 * This service provides a stable device ID that persists across app restarts and logouts.
 * The device ID is app-install scoped, not account scoped.
 */
...
sealed interface DeviceIdentityError {
     ...
     */
    data class PersistenceFailure(val message: String) : DeviceIdentityError
     ...
     * @property message A description of the error
     */
    data class ReadFailure(val message: String) : DeviceIdentityError
}
