 ...
 *
 * Supports control and discovery operations including start, stop, test connection, tool discovery,
 * and runtime status queries. This abstraction keeps protocol lifecycle handling independent from
 * command-specific runtime logic, so deterministic dummy behavior can later be replaced with real
 * runtime integration without touching transport routing.
 */
interface McpRuntimeCommandExecutor {
    /**
