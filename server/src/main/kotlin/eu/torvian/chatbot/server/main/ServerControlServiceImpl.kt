 ...
 * @property accountSecurityMode Account security policy passed to the application module.
...
class ServerControlServiceImpl(
    ...
    private fun <TEngine : ApplicationEngine, TConfiguration : ApplicationEngine.Configuration> createEmbeddedServer(
        ...
        return embeddedServer(
            ...
            chatBotServerModule(databaseConfig, encryptionConfig, jwtConfig, accountSecurityMode, corsConfig, reverseProxyConfig)
        }
    }
}