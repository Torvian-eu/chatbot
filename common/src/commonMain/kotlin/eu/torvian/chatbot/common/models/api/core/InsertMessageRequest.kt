 ...
 * @property targetMessageId The ID of the message to insert relative to.
 * @property position The position to insert the new message relative to the target message.
