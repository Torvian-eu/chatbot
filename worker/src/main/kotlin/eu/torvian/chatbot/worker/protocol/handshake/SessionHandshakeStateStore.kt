 ...
 */
interface SessionHandshakeStateStore {
    /**
     ...
     */
    fun markSucceeded(interactionId: String, welcome: SessionWelcomeState)
     ...
     */
    fun get(interactionId: String): SessionHandshakeState?
}
