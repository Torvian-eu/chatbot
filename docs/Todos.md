...
- New user account must be locked after registration until an admin unlocks it.
- User account will be locked after a certain number of failed login attempts.
- Should force user to change admin password on first login. (see InitialSetupService)