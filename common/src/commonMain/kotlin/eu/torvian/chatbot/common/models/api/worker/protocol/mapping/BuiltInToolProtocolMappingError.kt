...
/**
 * Logical failure returned while mapping built-in tool-call DTOs to or from worker protocol payloads.
 *
 ...
 */
sealed interface BuiltInToolProtocolMappingError {
    ...
    data class InvalidCommandType(
        val expected: String,
        val actual: String
    ) : BuiltInToolProtocolMappingError
